# src/artifacts/generate_lucidchart.py
"""
...
Usage:
    python -m src.artifacts.generate_lucidchart input.sql --output lucidchart.csv
"""
...
def ddl_to_lucidchart(
    ...
    print(f"   ✅ LucidChart CSV saved: {output_file.name}")
    print(f"      Tables: {len(tables)}, Columns: {len(rows)}")
